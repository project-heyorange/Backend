...
public class HabilidadeController extends BaseController {
	...
	public HabilidadeDesejada findByHabilidadeDesejadaId(Long id) {
	...
	@ResponseStatus(HttpStatus.OK)
	public HabilidadeMentor findByHabilidadeMentorId(Long id) {
	...
	@ResponseStatus(HttpStatus.OK)
	public HabilidadeMentorado findByHabilidadeMentoradoId(Long id) {
